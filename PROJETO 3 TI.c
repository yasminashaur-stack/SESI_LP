...
int main() {
    ...
    char rankingNome[100][50];
    int rankingPontos[100];
	...
	do {
		...
		printf("a - escolher nível de dificuldade\n");
    ...
    if(dificuldade == 1){
        printf("\nHistória facíl ainda não criada!\n");
        atraso(2000);
    }
        ...
        printf("\nhistória Dificíl ainda não criada!\n");
        atraso(2000);
    }
    ...
    default:
		...
		strcpy(rankingNome[totalJogadores], nome);
    rankingPontos[totalJogadores] = pontos;
